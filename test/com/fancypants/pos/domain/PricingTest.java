...
public class PricingTest {
    ...
    @Test
    public void shouldIndicateEqualityWhenSameInstance() {
        Pricing pricingWithNoDiscount1 = new Pricing("A", new BigDecimal("123.00"));

        assertThat(pricingWithNoDiscount1, equalTo(pricingWithNoDiscount1));
        assertThat(pricingWithNoDiscount1.hashCode(), equalTo(pricingWithNoDiscount1.hashCode()));
